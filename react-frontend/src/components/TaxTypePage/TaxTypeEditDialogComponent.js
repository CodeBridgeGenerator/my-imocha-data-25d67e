...
const TaxTypeCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Edit Tax Type" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
