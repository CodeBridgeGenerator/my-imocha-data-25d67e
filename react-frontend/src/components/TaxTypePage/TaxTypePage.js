    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Tax Type",
          type: "error",
          message: error.message || "Failed get Tax Type",
        });
      });
    ...
    <div className="mt-5">
      <div className="grid">
        <div className="col-6 flex justify-content-start">
          <h3 className="mb-0 ml-2">Tax Type </h3>
        </div>
      ...
      <div className="grid align-items-center">
        <div className="col-12" role="taxType-datatable">
          <TaxTypeDatatable
            items={data}
            fields={fields}
