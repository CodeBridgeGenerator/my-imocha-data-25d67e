...
const p_dateTemplate0 = (rowData, { rowIndex }) => <p >{(new Date(rowData.no)).toLocaleDateString()}</p>
...
const p_dateTemplate18 = (rowData, { rowIndex }) => <p >{(new Date(rowData.supplierpostalzone)).toLocaleDateString()}</p>
...
const pTemplate28 = (rowData, { rowIndex }) => <p >{rowData.buyerSaddressPostalzone}</p>
...
const p_dateTemplate32 = (rowData, { rowIndex }) => <p >{(new Date(rowData.paymentinformationcurrencyexchangerate)).toLocaleDateString()}</p>
const pTemplate33 = (rowData, { rowIndex }) => <p >{rowData.paymentinformationfrequencyofbilling}</p>
const pTemplate34 = (rowData, { rowIndex }) => <p >{rowData.paymentinformationbillingperiodstartdate}</p>
const pTemplate35 = (rowData, { rowIndex }) => <p >{rowData.paymentinformationbillingperiodenddate}</p>
...
const p_numberTemplate39 = (rowData, { rowIndex }) => <p >{rowData.paymentinformationprepaymentamount}</p>
const pTemplate40 = (rowData, { rowIndex }) => <p >{rowData.paymentinformationprepaymentdate}</p>
...
const pTemplate46 = (rowData, { rowIndex }) => <p >{rowData.shippingrecipientSaddresspostalzone}</p>
...
const p_dateTemplate56 = (rowData, { rowIndex }) => <p >{(new Date(rowData.invoicelineno)).toLocaleDateString()}</p>
...
const p_dateTemplate59 = (rowData, { rowIndex }) => <p >{(new Date(rowData.invoicelinequantity)).toLocaleDateString()}</p>
const pTemplate60 = (rowData, { rowIndex }) => <p >{rowData.invoicelineunitprice}</p>
const pTemplate61 = (rowData, { rowIndex }) => <p >{rowData.invoicelinemeasurement}</p>
const pTemplate62 = (rowData, { rowIndex }) => <p >{rowData.invoicelinesubtotal}</p>
const pTemplate63 = (rowData, { rowIndex }) => <p >{rowData.invoicelinecountryoforigin}</p>
const pTemplate64 = (rowData, { rowIndex }) => <p >{rowData.invoicelinetotalexcludingtax}</p>
const pTemplate65 = (rowData, { rowIndex }) => <p >{rowData.invoicelinetaxtype}</p>
const pTemplate66 = (rowData, { rowIndex }) => <p >{rowData.invoicelinetaxrate}</p>
const pTemplate67 = (rowData, { rowIndex }) => <p >{rowData.invoicelinetaxamount}</p>
const pTemplate68 = (rowData, { rowIndex }) => <p >{rowData.invoicelinedetailsoftaxexemption}</p>
const p_dateTemplate69 = (rowData, { rowIndex }) => <p >{(new Date(rowData.invoicelinetaxexemptionamountexempted)).toLocaleDateString()}</p>
const pTemplate70 = (rowData, { rowIndex }) => <p >{rowData.invoicelinediscountrate}</p>
const p_dateTemplate71 = (rowData, { rowIndex }) => <p >{(new Date(rowData.discountdetailsofamount)).toLocaleDateString()}</p>
const pTemplate72 = (rowData, { rowIndex }) => <p >{rowData.invoicelinedetailsofdiscountdescription}</p>
const pTemplate73 = (rowData, { rowIndex }) => <p >{rowData.invoicelinedetailsofchargefeeChargerate}</p>
const pTemplate74 = (rowData, { rowIndex }) => <p >{rowData.invoicelinedetailsofchargefeeChargeamount}</p>
const pTemplate75 = (rowData, { rowIndex }) => <p >{rowData.detailsoftaxtaxtype}</p>
const p_dateTemplate76 = (rowData, { rowIndex }) => <p >{(new Date(rowData.detailsoftaxtotaltaxableamountpertaxtype)).toLocaleDateString()}</p>
const pTemplate77 = (rowData, { rowIndex }) => <p >{rowData.detailsoftaxtotaltaxamountpertaxtype}</p>
const pTemplate78 = (rowData, { rowIndex }) => <p >{rowData.taxexemptiondetailsoftaxexemption}</p>
const p_dateTemplate79 = (rowData, { rowIndex }) => <p >{(new Date(rowData.taxexemptionamountexemptedfromtax)).toLocaleDateString()}</p>
const p_dateTemplate80 = (rowData, { rowIndex }) => <p >{(new Date(rowData.discountadditionaldiscountamount)).toLocaleDateString()}</p>
const p_dateTemplate81 = (rowData, { rowIndex }) => <p >{(new Date(rowData.discountadditionaldescription)).toLocaleDateString()}</p>
const p_dateTemplate82 = (rowData, { rowIndex }) => <p >{(new Date(rowData.feeamountadditionalfeeamount)).toLocaleDateString()}</p>
const p_dateTemplate83 = (rowData, { rowIndex }) => <p >{(new Date(rowData.feeamountadditionaldescription)).toLocaleDateString()}</p>
const p_dateTemplate84 = (rowData, { rowIndex }) => <p >{(new Date(rowData.totaldiscountvalue)).toLocaleDateString()}</p>
const pTemplate85 = (rowData, { rowIndex }) => <p >{rowData.totalfeeChargeamount}</p>
const pTemplate86 = (rowData, { rowIndex }) => <p >{rowData.totaltaxamount}</p>
const pTemplate87 = (rowData, { rowIndex }) => <p >{rowData.totalexcludingtax}</p>
const p_dateTemplate88 = (rowData, { rowIndex }) => <p >{(new Date(rowData.totalnetamount)).toLocaleDateString()}</p>
const pTemplate89 = (rowData, { rowIndex }) => <p >{rowData.totalincludingtax}</p>
const p_dateTemplate90 = (rowData, { rowIndex }) => <p >{(new Date(rowData.roundingamount)).toLocaleDateString()}</p>
const pTemplate91 = (rowData, { rowIndex }) => <p >{rowData.totalpayableamount}</p>
...
<Column field="no" header="No" body={p_dateTemplate0} filter={selectedFilterFields.includes("no")} hidden={selectedHideFields?.includes("no")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="invoicedateandtime" header="Invoice Date and Time (*)" body={pTemplate2} filter={selectedFilterFields.includes("invoicedateandtime")} hidden={selectedHideFields?.includes("invoicedateandtime")}  sortable style={{ minWidth: "8rem" }} />
<Column field="originaleInvoicereferencenumber" header="Original e-Invoice Reference Number" body={pTemplate3} filter={selectedFilterFields.includes("originaleInvoicereferencenumber")} hidden={selectedHideFields?.includes("originaleInvoicereferencenumber")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="supplierpostalzone" header="Supplier Postal zone" body={p_dateTemplate18} filter={selectedFilterFields.includes("supplierpostalzone")} hidden={selectedHideFields?.includes("supplierpostalzone")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="buyerSaddressPostalzone" header="Buyer's address (Postal zone)" body={pTemplate28} filter={selectedFilterFields.includes("buyerSaddressPostalzone")} hidden={selectedHideFields?.includes("buyerSaddressPostalzone")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="paymentinformationcurrencyexchangerate" header="Payment information Currency Exchange Rate" body={p_dateTemplate32} filter={selectedFilterFields.includes("paymentinformationcurrencyexchangerate")} hidden={selectedHideFields?.includes("paymentinformationcurrencyexchangerate")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="paymentinformationbillingperiodstartdate" header="Payment information Billing Period Start Date" body={pTemplate34} filter={selectedFilterFields.includes("paymentinformationbillingperiodstartdate")} hidden={selectedHideFields?.includes("paymentinformationbillingperiodstartdate")}  sortable style={{ minWidth: "8rem" }} />
<Column field="paymentinformationbillingperiodenddate" header="Payment information Billing Period End Date" body={pTemplate35} filter={selectedFilterFields.includes("paymentinformationbillingperiodenddate")} hidden={selectedHideFields?.includes("paymentinformationbillingperiodenddate")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="paymentinformationprepaymentamount" header="Payment information PrePayment Amount" body={p_numberTemplate39} filter={selectedFilterFields.includes("paymentinformationprepaymentamount")} hidden={selectedHideFields?.includes("paymentinformationprepaymentamount")}  sortable style={{ minWidth: "8rem" }} />
<Column field="paymentinformationprepaymentdate" header="Payment information PrePayment Date" body={pTemplate40} filter={selectedFilterFields.includes("paymentinformationprepaymentdate")} hidden={selectedHideFields?.includes("paymentinformationprepaymentdate")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="shippingrecipientSaddresspostalzone" header="Shipping Recipient’s Address Postal Zone" body={pTemplate46} filter={selectedFilterFields.includes("shippingrecipientSaddresspostalzone")} hidden={selectedHideFields?.includes("shippingrecipientSaddresspostalzone")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="invoicelineno" header="Invoice Line No" body={p_dateTemplate56} filter={selectedFilterFields.includes("invoicelineno")} hidden={selectedHideFields?.includes("invoicelineno")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="invoicelinequantity" header="Invoice Line Quantity" body={p_dateTemplate59} filter={selectedFilterFields.includes("invoicelinequantity")} hidden={selectedHideFields?.includes("invoicelinequantity")}  sortable style={{ minWidth: "8rem" }} />
<Column field="invoicelineunitprice" header="Invoice Line Unit Price (*)" body={pTemplate60} filter={selectedFilterFields.includes("invoicelineunitprice")} hidden={selectedHideFields?.includes("invoicelineunitprice")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="invoicelinesubtotal" header="Invoice Line Subtotal (*)" body={pTemplate62} filter={selectedFilterFields.includes("invoicelinesubtotal")} hidden={selectedHideFields?.includes("invoicelinesubtotal")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="invoicelinetotalexcludingtax" header="Invoice Line Total Excluding Tax(*)" body={pTemplate64} filter={selectedFilterFields.includes("invoicelinetotalexcludingtax")} hidden={selectedHideFields?.includes("invoicelinetotalexcludingtax")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="invoicelinetaxrate" header="Invoice Line Tax Rate (%)" body={pTemplate66} filter={selectedFilterFields.includes("invoicelinetaxrate")} hidden={selectedHideFields?.includes("invoicelinetaxrate")}  sortable style={{ minWidth: "8rem" }} />
<Column field="invoicelinetaxamount" header="Invoice Line Tax Amount (*)" body={pTemplate67} filter={selectedFilterFields.includes("invoicelinetaxamount")} hidden={selectedHideFields?.includes("invoicelinetaxamount")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="invoicelinetaxexemptionamountexempted" header="Invoice Line Tax Exemption Amount Exempted" body={p_dateTemplate69} filter={selectedFilterFields.includes("invoicelinetaxexemptionamountexempted")} hidden={selectedHideFields?.includes("invoicelinetaxexemptionamountexempted")}  sortable style={{ minWidth: "8rem" }} />
<Column field="invoicelinediscountrate" header="Invoice Line Discount Rate (%)" body={pTemplate70} filter={selectedFilterFields.includes("invoicelinediscountrate")} hidden={selectedHideFields?.includes("invoicelinediscountrate")}  sortable style={{ minWidth: "8rem" }} />
<Column field="discountdetailsofamount" header="Discount Details of Amount" body={p_dateTemplate71} filter={selectedFilterFields.includes("discountdetailsofamount")} hidden={selectedHideFields?.includes("discountdetailsofamount")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="invoicelinedetailsofchargefeeChargerate" header="Invoice Line Details of Charge Fee/Charge Rate (%)" body={pTemplate73} filter={selectedFilterFields.includes("invoicelinedetailsofchargefeeChargerate")} hidden={selectedHideFields?.includes("invoicelinedetailsofchargefeeChargerate")}  sortable style={{ minWidth: "8rem" }} />
<Column field="invoicelinedetailsofchargefeeChargeamount" header="Invoice Line Details of Charge Fee/Charge Amount" body={pTemplate74} filter={selectedFilterFields.includes("invoicelinedetailsofchargefeeChargeamount")} hidden={selectedHideFields?.includes("invoicelinedetailsofchargefeeChargeamount")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="detailsoftaxtotaltaxableamountpertaxtype" header="Details of tax Total Taxable Amount per Tax Type" body={p_dateTemplate76} filter={selectedFilterFields.includes("detailsoftaxtotaltaxableamountpertaxtype")} hidden={selectedHideFields?.includes("detailsoftaxtotaltaxableamountpertaxtype")}  sortable style={{ minWidth: "8rem" }} />
<Column field="detailsoftaxtotaltaxamountpertaxtype" header="Details of tax Total Tax Amount Per Tax Type (*)" body={pTemplate77} filter={selectedFilterFields.includes("detailsoftaxtotaltaxamountpertaxtype")} hidden={selectedHideFields?.includes("detailsoftaxtotaltaxamountpertaxtype")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="taxexemptionamountexemptedfromtax" header="Tax exemption Amount Exempted from Tax" body={p_dateTemplate79} filter={selectedFilterFields.includes("taxexemptionamountexemptedfromtax")} hidden={selectedHideFields?.includes("taxexemptionamountexemptedfromtax")}  sortable style={{ minWidth: "8rem" }} />
<Column field="discountadditionaldiscountamount" header="Discount Additional Discount Amount" body={p_dateTemplate80} filter={selectedFilterFields.includes("discountadditionaldiscountamount")} hidden={selectedHideFields?.includes("discountadditionaldiscountamount")}  sortable style={{ minWidth: "8rem" }} />
<Column field="discountadditionaldescription" header="Discount Additional Description" body={p_dateTemplate81} filter={selectedFilterFields.includes("discountadditionaldescription")} hidden={selectedHideFields?.includes("discountadditionaldescription")}  sortable style={{ minWidth: "8rem" }} />
<Column field="feeamountadditionalfeeamount" header="Fee Amount Additional Fee Amount" body={p_dateTemplate82} filter={selectedFilterFields.includes("feeamountadditionalfeeamount")} hidden={selectedHideFields?.includes("feeamountadditionalfeeamount")}  sortable style={{ minWidth: "8rem" }} />
<Column field="feeamountadditionaldescription" header="Fee Amount Additional Description" body={p_dateTemplate83} filter={selectedFilterFields.includes("feeamountadditionaldescription")} hidden={selectedHideFields?.includes("feeamountadditionaldescription")}  sortable style={{ minWidth: "8rem" }} />
<Column field="totaldiscountvalue" header="Total Discount Value" body={p_dateTemplate84} filter={selectedFilterFields.includes("totaldiscountvalue")} hidden={selectedHideFields?.includes("totaldiscountvalue")}  sortable style={{ minWidth: "8rem" }} />
<Column field="totalfeeChargeamount" header="Total Fee/Charge Amount" body={pTemplate85} filter={selectedFilterFields.includes("totalfeeChargeamount")} hidden={selectedHideFields?.includes("totalfeeChargeamount")}  sortable style={{ minWidth: "8rem" }} />
<Column field="totaltaxamount" header="Total Tax Amount (*)" body={pTemplate86} filter={selectedFilterFields.includes("totaltaxamount")} hidden={selectedHideFields?.includes("totaltaxamount")}  sortable style={{ minWidth: "8rem" }} />
<Column field="totalexcludingtax" header="Total Excluding Tax (*)" body={pTemplate87} filter={selectedFilterFields.includes("totalexcludingtax")} hidden={selectedHideFields?.includes("totalexcludingtax")}  sortable style={{ minWidth: "8rem" }} />
<Column field="totalnetamount" header="Total Net Amount" body={p_dateTemplate88} filter={selectedFilterFields.includes("totalnetamount")} hidden={selectedHideFields?.includes("totalnetamount")}  sortable style={{ minWidth: "8rem" }} />
<Column field="totalincludingtax" header="Total Including Tax (*)" body={pTemplate89} filter={selectedFilterFields.includes("totalincludingtax")} hidden={selectedHideFields?.includes("totalincludingtax")}  sortable style={{ minWidth: "8rem" }} />
<Column field="roundingamount" header="Rounding Amount" body={p_dateTemplate90} filter={selectedFilterFields.includes("roundingamount")} hidden={selectedHideFields?.includes("roundingamount")}  sortable style={{ minWidth: "8rem" }} />
<Column field="totalpayableamount" header="Total Payable Amount (*)" body={pTemplate91} filter={selectedFilterFields.includes("totalpayableamount")} hidden={selectedHideFields?.includes("totalpayableamount")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="consolidated" header="Original e-Invoice Reference Number" body={pTemplate93} filter={selectedFilterFields.includes("consolidated")} hidden={selectedHideFields?.includes("consolidated")}  sortable style={{ minWidth: "8rem" }} />
