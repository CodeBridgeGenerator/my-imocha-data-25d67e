    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Invoice",
          type: "error",
          message: error.message || "Failed get invoice",
        });
      });
        ...
        <div className="card w-full">
          <div className="grid ">
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">Invoice Type (*)</label>
              <p className="m-0 ml-3">{_entity?.invoicetype}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Invoice Date and Time (*)
              </label>
              <p className="m-0 ml-3">{_entity?.invoicedateandtime}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
            ...
            <div className="col-12 md:col-6 lg:col-3">
              ...
              <p className="m-0 ml-3">{_entity?.supplierSname}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">Supplier's TIN (*)</label>
              <p className="m-0 ml-3">{_entity?.supplierStin}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
              ...
              <p className="m-0 ml-3">
                {_entity?.supplierSsstregistrationnumber}
              </p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
              ...
              <p className="m-0 ml-3">{_entity?.supplierSidentifiertype}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Supplier Identifier Number (*)
              </label>
              <p className="m-0 ml-3">{_entity?.supplieridentifiernumber}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Supplier's MSIC code (*)
              </label>
              <p className="m-0 ml-3">{_entity?.supplierSmsiccode}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
            ...
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">Supplier's e-mail</label>
              <p className="m-0 ml-3">{_entity?.supplierSeMail}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
              ...
              <p className="m-0 ml-3">
                {_entity?.thefirstsupplierScontactnumber}
              </p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
              ...
              <p className="m-0 ml-3">{_entity?.supplierScontactnumber}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Supplier Country name (*)
              </label>
              <p className="m-0 ml-3">{_entity?.suppliercountryname}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Supplier State name (*)
              </label>
              <p className="m-0 ml-3">{_entity?.supplierstatename}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Supplier City name (*)
              </label>
              <p className="m-0 ml-3">{_entity?.suppliercityname}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">Buyer's name (*)</label>
              <p className="m-0 ml-3">{_entity?.buyerSname}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">Buyer's TIN</label>
              <p className="m-0 ml-3">{_entity?.buyerStin}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Buyer's SST Registration Number
              </label>
              <p className="m-0 ml-3">{_entity?.buyerSsstregistrationnumber}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Buyer Identifier Type
              </label>
              <p className="m-0 ml-3">{_entity?.buyeridentifiertype}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
            ...
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">Buyer's e-mail</label>
              <p className="m-0 ml-3">{_entity?.buyerSeMail}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Buyer's address (*) (Country name)
              </label>
              <p className="m-0 ml-3">{_entity?.buyerSaddressCountryname}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Buyer's address (*) (State name)
              </label>
              <p className="m-0 ml-3">{_entity?.buyerSaddressStatename}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Buyer's address (City name)
              </label>
              <p className="m-0 ml-3">{_entity?.buyerSaddressCityname}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Buyer's address (Postal zone)
              </label>
              <p className="m-0 ml-3">{_entity?.buyerSaddressPostalzone}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                The first buyer's contact number (*)
              </label>
              <p className="m-0 ml-3">{_entity?.thefirstbuyerScontactnumber}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Buyer's Contact Number (*)
              </label>
              <p className="m-0 ml-3">{_entity?.buyerScontactnumber}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
            ...
            <div className="col-12 md:col-6 lg:col-3">
              ...
              <p className="m-0 ml-3">
                {_entity?.paymentinformationpaymentmode}
              </p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
            ...
            <div className="col-12 md:col-6 lg:col-3">
              ...
              <p className="m-0 ml-3">
                {_entity?.paymentinformationpaymentterms}
              </p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
              ...
              <p className="m-0 ml-3">
                {Number(_entity?.paymentinformationprepaymentamount)}
              </p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
            ...
            <div className="col-12 md:col-6 lg:col-3">
              ...
              <p className="m-0 ml-3">{_entity?.shippingrecipientSname}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
            ...
            <div className="col-12 md:col-6 lg:col-3">
              ...
              <p className="m-0 ml-3">{_entity?.shippingrecipientStin}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
            ...
            <div className="col-12 md:col-6 lg:col-3">
              ...
              <p className="m-0 ml-3">{_entity?.otherinformationincoterms}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
            ...
            <div className="col-12 md:col-6 lg:col-3">
              ...
              <p className="m-0 ml-3">{_entity?.invoicelineclassification}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Invoice Line Product name (*)
              </label>
              <p className="m-0 ml-3">{_entity?.invoicelineproductname}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Invoice Line Unit Price (*)
              </label>
              <p className="m-0 ml-3">{_entity?.invoicelineunitprice}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Invoice Line Measurement
              </label>
              <p className="m-0 ml-3">{_entity?.invoicelinemeasurement}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Invoice Line Subtotal (*)
              </label>
              <p className="m-0 ml-3">{_entity?.invoicelinesubtotal}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Invoice Line Country of Origin
              </label>
              <p className="m-0 ml-3">{_entity?.invoicelinecountryoforigin}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
              ...
              <p className="m-0 ml-3">
                {_entity?.invoicelinetotalexcludingtax}
              </p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
              ...
              <p className="m-0 ml-3">{_entity?.invoicelinetaxtype}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Invoice Line Tax Rate (%)
              </label>
              <p className="m-0 ml-3">{_entity?.invoicelinetaxrate}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Invoice Line Tax Amount (*)
              </label>
              <p className="m-0 ml-3">{_entity?.invoicelinetaxamount}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
            ...
            <div className="col-12 md:col-6 lg:col-3">
              ...
              <p className="m-0 ml-3">{_entity?.invoicelinediscountrate}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
            ...
            <div className="col-12 md:col-6 lg:col-3">
              ...
              <p className="m-0 ml-3">{_entity?.detailsoftaxtaxtype}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
            ...
            <div className="col-12 md:col-6 lg:col-3">
              ...
              <p className="m-0 ml-3">{_entity?.totalfeeChargeamount}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Total Tax Amount (*)
              </label>
              <p className="m-0 ml-3">{_entity?.totaltaxamount}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Total Excluding Tax (*)
              </label>
              <p className="m-0 ml-3">{_entity?.totalexcludingtax}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Total Including Tax (*)
              </label>
              <p className="m-0 ml-3">{_entity?.totalincludingtax}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">
                Total Payable Amount (*)
              </label>
              <p className="m-0 ml-3">{_entity?.totalpayableamount}</p>
            </div>
            <div className="col-12 md:col-6 lg:col-3">
              <label className="text-sm text-primary">Invoice Number</label>
            ...
            <div className="col-12 md:col-6 lg:col-3">
              ...
              <p className="m-0 ml-3">{_entity?.consolidated}</p>
            </div>
