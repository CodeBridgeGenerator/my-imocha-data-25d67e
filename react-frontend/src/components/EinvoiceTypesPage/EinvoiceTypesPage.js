...
const EInvoiceTypesPage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          ...
          type: "error",
          message: error.message || "Failed get E-invoice Types",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("eInvoiceTypes").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
