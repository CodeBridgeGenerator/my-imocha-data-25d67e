...
<Column field="eInvoicetypes" header="e-Invoice Types" body={pTemplate0} filter={selectedFilterFields.includes("eInvoicetypes")} hidden={selectedHideFields?.includes("eInvoicetypes")}  sortable style={{ minWidth: "8rem" }} />
