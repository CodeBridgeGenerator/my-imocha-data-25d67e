...
const PaymentModePage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Payment Mode",
          type: "error",
          message: error.message || "Failed get Payment Mode",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("paymentMode").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
    ...
    <div className="mt-5">
      <div className="grid">
        <div className="col-6 flex justify-content-start">
          <h3 className="mb-0 ml-2">Payment Mode </h3>
        </div>
      ...
      <div className="grid align-items-center">
        <div className="col-12" role="paymentMode-datatable">
