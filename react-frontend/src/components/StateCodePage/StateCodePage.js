    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "State Code",
          type: "error",
          message: error.message || "Failed get State Code",
        });
      });
    ...
    <div className="mt-5">
      <div className="grid">
        <div className="col-6 flex justify-content-start">
          <h3 className="mb-0 ml-2">State Code </h3>
        </div>
      ...
      <div className="grid align-items-center">
        <div className="col-12" role="stateCode-datatable">
          <StateCodeDatatable
            items={data}
            fields={fields}
