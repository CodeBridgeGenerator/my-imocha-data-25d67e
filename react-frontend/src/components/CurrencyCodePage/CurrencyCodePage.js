...
const CurrencyCodePage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Currency Code",
          type: "error",
          message: error.message || "Failed get Currency Code",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("currencyCode").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
    ...
    <div className="mt-5">
      <div className="grid">
        <div className="col-6 flex justify-content-start">
          <h3 className="mb-0 ml-2">Currency Code </h3>
        </div>
      ...
      <div className="grid align-items-center">
        <div className="col-12" role="currencyCode-datatable">
          <CurrencyCodeDatatable
            items={data}
            fields={fields}
