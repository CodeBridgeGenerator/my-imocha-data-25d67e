...
const ClassificationCodeDataTable = ({
  items,
  fields,
  onEditRow,
  onRowDelete,
  ...
  const pTemplate0 = (rowData, { rowIndex }) => (
    <p>{rowData.classificationcode}</p>
  );
    ...
    <>
      ...
      >
        <Column
          ...
          body={pTemplate0}
          filter={selectedFilterFields.includes("classificationcode")}
          hidden={selectedHideFields?.includes("classificationcode")}
          sortable
          style={{ minWidth: "8rem" }}
        />
      ...
      <Dialog
        header="Upload ClassificationCode Data"
        visible={showUpload}
      ...
      <Dialog
        header="Search ClassificationCode"
