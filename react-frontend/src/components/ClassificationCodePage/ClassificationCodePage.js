...
const ClassificationCodePage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          ...
          type: "error",
          message: error.message || "Failed get Classification Code",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("classificationCode").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
    ...
    <div className="mt-5">
      <div className="grid">
        <div className="col-6 flex justify-content-start">
          <h3 className="mb-0 ml-2">Classification Code </h3>
        </div>
        <div className="col-6 flex justify-content-end">
          <>
            <Button
              ...
              role="classificationCode-add-button"
            />
            <SplitButton
      ...
      <div className="grid align-items-center">
        <div className="col-12" role="classificationCode-datatable">
          <ClassificationCodeDatatable
            items={data}
            fields={fields}
